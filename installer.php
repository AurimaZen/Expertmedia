...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221217_expertmediauzduotis_8a3f64bcc3923b107906_20221219061643_archive.zip';
        const ARCHIVE_SIZE       = '17210528';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '8a3f64b-19061643';
        const SECONDARY_PACKAGE_HASH = '0774b0b-19061643';
        const VERSION            = '1.5.1';
